...
| 3 | Volodymyr Levchuk | [A lightweight, local-first (mqtt) sensors telemetry hub](https://github.com/vol-lev/varta-hub) | A lightweight, local-first (MQTT) sensors telemetry hub - an engine to build analytics and automations. | yes |
...
| 11  | Yuriy Sh.  | [Mean Reversion Trading Bot](https://github.com/yurii2007/mean-reversion-trading-bot) | A fully customizable CLI bot in Rust for cryptocurrency trading using a mean reversion strategy. |
| 12  | Ivan R.      | [StegoWave](https://github.com/Van4ooo/StegoWave/tree/capstone-project) | An audio steganography service with a CLI client written in Rust. |
